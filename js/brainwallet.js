...
/*
	ASCII using symbols with codes 	00-7F,
	extended ASCII -				00-FF
*/
...
//utf8.js
//saved from here: https://github.com/mathiasbynens/utf8.js
...
//Usage and test:
//var string = '守护村子';
//document.write('<br> UTF-8 encoded string: ', string);								//守护村子
//document.write('<br> UTF-8 to ASCII encoding: ', utf8.encode(string));				//å®æ¤æå­
//document.write('<br> UTF-8 from ASCII: ', utf8.decode(utf8.encode(string)));			//守护村子

    // stringToBytes, exception-safe
    function stringToBytes(str) {
	  if(!isASCII(str, true)){str = utf8.encode(str);} //if text not have extended ASCII encoding - then encode this as utf-8 to ASCII
      try {
...
//		console.log('translate', 'val: ', $('#src').val(), ', from: ', from, ', to: ', to);
        ...
        bytes = stringToBytes(str); //default byte-array from text string.
